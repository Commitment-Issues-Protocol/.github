...
Your git graph used to be meaningful, attestable to an individual in all their creativity, knowledge & technological wisdom. Though with the rise of AI agents committing & creating code, it seems now all this contribution graph attests to is how much compute power your agent used.
...
That budget line is the piece we care most about. A human presence check that can be spammed is theatre. Because AgentKit counts usage per human rather than per key, the limit follows the person across every agent and machine they run, so rubber-stamping becomes a thing you spend.
...
Built at ETHGlobal Lisbon, 24 to 26 July 2026. Helping developers develop for the future. Thanks for trusting us to fix your commitment issues <3. 
<div align="center">
